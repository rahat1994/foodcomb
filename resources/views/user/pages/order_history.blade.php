            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="title title-4 text-center">
                    <div class="title--content">
                        <div class="title--subtitle">Orders</div>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr class="cart-product">
                                <th class="cart-product-item">Order</th>
                        ...
                        <tbody>
                            ...
                            <?php
                                $order_content = json_decode($order->order_body);
                                // dd($order_content);
                            ?>
                            <tr class="cart-product">
                                <td class="cart-product-item">
                                    ...
                                    @foreach($order_content as $key => $content)
                                    <div class="cart-product-name">
                                        <h6>{{$key}} {{$content->food_name}}</h6>
                                    </div>
                                    @endforeach
                                </td>
