                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="contact-form">
                                <form method="post" action="{{url('/reviewSubmit')}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" class="form-control" name="customer_name" id="name" placeholder="Full Name:" required>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <input value="Send Message" id="submit_contact_form" type="submit" name="submit" class="btn btn--secondary btn--block mt-10">
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12">
												<!--Alert Message-->
                            					<div class="contact-result"></div>
